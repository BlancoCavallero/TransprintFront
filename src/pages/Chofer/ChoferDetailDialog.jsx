...
import { Plus, User, Phone, FileText, Hash, AlertCircle, Mail } from 'lucide-react';
...
export const ChoferDetailDialog = ({ open, onOpenChange, chofer, onReactivar, loadingReactivar }) => {
  ...
  // Estilos copiados de ClienteDetailDialog
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        {/* Aplicamos el mismo ancho y padding que ClienteDetail y el Form centrado */}
                ...
                <div style={{ padding: '18px', backgroundColor: '#fff7ed', border: '1px solid #ffedd5', borderRadius: '12px' }} className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-orange-700 mt-1 leading-relaxed">
                      Este chofer está inactivo. Debe reactivarlo para poder asignarlo a viajes.
                    </p>
                    {onReactivar && (
                      <Button
              ...
              <div style={cardStyle}>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="font-medium text-slate-900">{chofer.persona?.nombre || chofer.nombre || '—'}</p>
                  </div>
                  <div>
                    <p className="text-xs text-slate-500 font-semibold uppercase">Apellido</p>
                    <p className="font-medium text-slate-900">{chofer.persona?.apellido || chofer.apellido || '—'}</p>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-6">
                  <div>
                ...
                <div className="flex flex-col items-center justify-center h-64 space-y-4 bg-slate-50 rounded-xl border border-dashed">
                  ...
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-slate-500 max-w-xs">
                      Debe reactivar al chofer para gestionar su documentación.
                    </p>
                  </div>
                </div>
              ) : (
