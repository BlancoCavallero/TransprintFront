              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  <div style={{ ...cardStyle, backgroundColor: '#f8fafc' }}>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div>
                        <p className="text-xs text-slate-400 font-semibold uppercase">ID Chofer</p>
                        <p className="text-xs font-mono">{chofer.idChofer || chofer.id}</p>
                      </div>
                      <div>
                        <p className="text-xs text-slate-400 font-semibold uppercase">ID Persona</p>
                        <p className="text-xs font-mono">{chofer.idPersona || 'N/A'}</p>
                      </div>
                    </div>
                  </div>
                </div>
