          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="detalles" style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                {/* Info Adicional y Sistema */}
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  <div style={cardStyle}>
                    <h3 className="font-bold text-sm uppercase tracking-wider flex items-center gap-2" style={{ color: '#592673' }}>
                      <Calendar className="h-4 w-4" /> Especificaciones
                    </h3>
                    <div>
                      <p className="text-xs text-slate-500 font-semibold uppercase">Año de Fabricación</p>
                  ...
                  <div style={{ ...cardStyle, backgroundColor: '#f8fafc' }}>
                    ...
                    <div>
                      <p className="text-xs text-slate-400 font-semibold uppercase">ID Vehículo</p>
                      <p className="text-xs font-mono">{vehiculo.idVehiculo || vehiculo.id}</p>
                    </div>
                  </div>
                </div>
              </div>
